import { VersionedTransaction, ComputeBudgetProgram, Keypair } from '@solana/web3.js';
...
import { logger, JITO_RPC, QUOTE_API, SWAP_API } from '@horizon/shared';
...
export async function swap(
  ...
  try {
    ...
    if (!QUOTE_API || !JITO_RPC || !QUOTE_API || !SWAP_API) {
