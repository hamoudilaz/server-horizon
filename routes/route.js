...
import { demoBuyhandler, demoSellHandler, fetchDemoTokens, getSessionState, startDemo, validateDemoSession, resetDemo } from '../utils/demo/buy.js';
...
export default function registerRoutes(app) {
    app.post('/api/buy', { preHandler: validateSession }, buyHandler);

    app.post('/api/sell', { preHandler: validateSession }, sellHandler);
    ...
    app.post('/api/demo/buy', demoBuyhandler); // Add preHandler

    app.post('/api/demo/sell', demoSellHandler); // Add preHandler
